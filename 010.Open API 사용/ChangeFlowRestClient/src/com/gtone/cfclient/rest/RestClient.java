...
public class RestClient
{
  ...
  public JSONObject getJsonByJson(String paramString, Map<String, ?> paramMap)
    throws IOException
  {
    return getJson("application/json", paramString , JSONObject.fromObject(paramMap).toString());
  }

  public JSONObject getJsonByText(String paramString)
    throws IOException
  {
    return getJson("application/text", paramString , null);
  }

  public JSONObject getJsonByText(String paramString1, String paramString2)
    throws IOException
  {
    return getJson("application/text", paramString1 + "?" + paramString2, null);
  }

  public JSONObject getJson(String paramString1, String paramString2, String paramString3)
    throws IOException
  {
  ...
  private String getHttpContents(String paramString1, String paramString2, String paramString3)
    throws IOException
  {
  ...
  private String getHttpsContents(String paramString1, String paramString2, String paramString3)
